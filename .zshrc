...
alias nixconfig="nvim ~/.nixrc/configuration.nix"
alias nix-rebuild="sudo nixos-rebuild switch --flake ~/.nixrc"
alias b="ping nos.nl"
alias cp="cp -v"
alias mv="mv -v"
alias "..."="../.."
...
function school() {
  if [ -z "$1" ]; then
		...
		cd ~/Documents/school/SD1B/OOP || return
	elif [ "$1" = "slb" ]; then
		cd ~/Documents/school/SD1B/SLB || return
	elif [ "$1" = "slbp" ]; then
		cd ~/Documents/school/SD1B/SLB+ || return
	elif [ "$1" = "wdv" ]; then
		cd ~/Documents/school/SD1B/WDV || return
	elif [ "$1" = "comp" ]; then
		cd ~/Documents/school/SD1B/Computational || return
	elif [ "$1" = "js" ]; then
		cd ~/Documents/school/SD1B/JS || return
	elif [ "$1" = "db" ]; then
		cd ~/Documents/school/SD1B/DB || return
...
function php-start() {
	port=$(($RANDOM%100+5500))
	
	php -S 127.0.0.1:$port & ;
	if [ $1 -ne 0 ]; then
		firefox --new-window 127.0.0.1:$port
	else
		firefox --new-window 127.0.0.1:$port/$1
